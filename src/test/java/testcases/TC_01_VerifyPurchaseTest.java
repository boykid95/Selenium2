...
import vn.agest.selenium.pageObjects.ShoppingCartPage;
...
public class TC_01_VerifyPurchaseTest extends BaseTest {
    ...
    public void verifyUserCanBuyItemSuccessfully() {
        ...
        categoryPage = homePage.navigateToCategoryPage(ProductCategory.ELECTRONIC_COMPONENTS_SUPPLIES);

        // ======================= STEP 4: ADD RANDOM PRODUCT TO CART ==============
        List<Product> selectedProducts = categoryPage.addRandomProductToCart(1);

        // ======================= STEP 5: CLICK CART BUTTON TO OPEN SHOPPING CART PAGE ========================
        // ======================= STEP 6: VERIFY INFORMATION IN CART ========================
        shoppingCartPage = categoryPage.navigateToShoppingCartPage();
        List<Product> actualCartProducts = shoppingCartPage.getCartProductInfo();
        ...
        orderStatusPage = checkoutPage.navigateToOrderStatusPage();
